package dieterbaier.sbk.repository;

import dieterbaier.sbk.SimpleBookkeeperApp;
import dieterbaier.sbk.config.Constants;
import dieterbaier.sbk.config.audit.AuditEventConverter;
import dieterbaier.sbk.domain.PersistentAuditEvent;
...
import static dieterbaier.sbk.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
